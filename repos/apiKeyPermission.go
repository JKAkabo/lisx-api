...
func SelectAPIKeyPermissionByAPIKeyID(apiKeyID int) (apiKeyPermissions []models.UserPermission, err error) {
...
func SelectAPIKeyPermissionByAPIKeyIDAndResource(apiKeyID int, resource string) (apiKeyPermission models.UserPermission, err error) {
